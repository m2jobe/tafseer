  ...
  render() {
    ...
    return (
      <ul className="nav" ref={(c) => { this.nav = c; }}>
        ...
        */}
        <li><FlatButton href="#/app/artist/Paul Childers"><i className="nav-icon material-icons">music_note</i><span className="nav-text">Featured Artist</span></FlatButton></li>
